...
enum Risk: String, Identifiable, CaseIterable {
    case highRisk  = "High Risk"  // rawValue = "High Risk"
    case difficult = "Difficult"  // rawValue = "Difficult"
    case moderate  = "Moderate"   // rawValue = "Moderate"
    case easy      = "Easy"       // rawValue = "Easy"
